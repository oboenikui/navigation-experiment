...
class TrendFragment : DaggerFragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView.adapter = TrendAdapter(DUMMY_TRENDS).apply {
            onContentItemClick = {
                findNavController().navigate(TrendFragmentDirections.actionTrendToDetail(it))
            }
        }
    ...
    companion object {
        private val DUMMY_TRENDS = listOf(
            Trend(
                name = "Android",
                contents = listOf(
                    Content(
